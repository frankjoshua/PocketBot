...
public class ChatterBotFactory {
    ...
    public ChatterBot create(final ChatterBotType type) throws Exception {
        return create(type, null);
    }

    public ChatterBot create(final ChatterBotType type, final Object arg) throws Exception {
        switch (type) {
            case CLEVERBOT:
