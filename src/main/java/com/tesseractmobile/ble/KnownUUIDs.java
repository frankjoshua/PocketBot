package com.tesseractmobile.ble;
...
public class KnownUUIDs extends StandardUUIDs {
    ...
    static {
        ...
        aMap.put(BluetoothService.UUID_SERVICE.toUpperCase(), "Nordic UART");
    ...
    static {
        ...
        // Uart
        aMap.put(BluetoothService.UUID_RX.toUpperCase(), "RX Buffer");
        aMap.put(BluetoothService.UUID_TX.toUpperCase(), "TX Buffer");
        aMap.put(BluetoothService.UUID_DFU.toUpperCase(), "DFU Service");
